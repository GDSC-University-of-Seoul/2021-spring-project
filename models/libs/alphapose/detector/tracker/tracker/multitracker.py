...
class JDETracker(object):
    def __init__(self, args, frame_rate=30):
        ...
        self.model.load_state_dict(
            torch.load(args.weights, map_location="cpu")["model"], strict=False
        )
