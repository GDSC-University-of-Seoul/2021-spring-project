...
//        while( dir.openNextFile())
        while( file)
        {
          ...
          String fn,fs;
          fn = file.name();
          int pos = fn.lastIndexOf("/"); //¬Ú¬ë¬Ö¬Þ ¬ß¬Ñ¬é¬Ñ¬Ý¬à ¬æ¬Ñ¬Û¬Ý¬Ñ ¬á¬à ¬á¬à¬ã¬Ý¬Ö¬Õ¬ß¬Ö¬Þ¬å "/"
          fn.remove(0, pos+1); //¬µ¬Õ¬Ñ¬Ý¬ñ¬Ö¬Þ ¬Ó¬ã¬Ö ¬Õ¬à ¬Ú¬Þ¬Ö¬ß¬Ú ¬æ¬Ñ¬Û¬Ý¬Ñ ¬Ó¬Ü¬Ý¬ð¬é¬Ú¬ä¬Ö¬Ý¬î¬ß¬à
          fs = String(file.size());
          if(file.isDirectory()){
